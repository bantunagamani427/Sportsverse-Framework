...
public class TC_004_FanTokensTest {
	...
	public void fantokenstest() throws InterruptedException {
		...
		act3.moveToElement(liveTokensLink).click().perform();
		Thread.sleep(3000);
		...
		act4.moveToElement(contactSupportLink).click().perform();
		...
		for( WebElement FaqLink:FaqLinks) {
			act5.moveToElement(FaqLink).click().perform();
			Thread.sleep(1000);
			FaqLink.click();
		}
		...
		for(WebElement socialMediaIcon1:socialMediaIcons1) {
			act6.moveToElement(socialMediaIcon1).click().perform();
			Thread.sleep(3000);
		...
		for(WebElement firstLink:firstLinks) {
			act7.moveToElement(firstLink).click().perform();
			Thread.sleep(3000);
			driver.navigate().back();
			Thread.sleep(3000);
		...
		for(WebElement SecondLink:SecondLinks) {
			act8.moveToElement(SecondLink).click().perform();
			Thread.sleep(3000);
			driver.navigate().back();
			Thread.sleep(3000);
		...
		act9.moveToElement(learn1Link).click().perform();
		Thread.sleep(3000);
		driver.navigate().back();
